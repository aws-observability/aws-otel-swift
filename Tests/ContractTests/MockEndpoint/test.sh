...
echo "$HTTP_STATUS_200 \n"
if [[ "$HTTP_STATUS_200" -ne "200" ]]; then
...
echo "$HTTP_STATUS_404 \n"
if [[ "$HTTP_STATUS_404" -ne "404" ]]; then
...
echo "$HTTP_STATUS_500 \n"
if [[ "$HTTP_STATUS_500" -ne "500" ]]; then
