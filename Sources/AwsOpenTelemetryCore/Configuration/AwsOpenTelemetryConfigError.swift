 ...
 */
public enum AwsOpenTelemetryConfigError: Error, Equatable {
  /// Indicates that a URL string could not be parsed into a valid URL
  case malformedURL(String)

  /// Indicates that the SDK has already been initialized
